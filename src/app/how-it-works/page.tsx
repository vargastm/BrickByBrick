...
const steps = [
  ...
  },
  {
    ...
    description:
      'Monitor construction progress in real time through on-chain milestones. Each milestone is independently verified using AI and recorded on the blockchain, ensuring full transparency and accountability.',
    icon: (
      <svg
        className="h-8 w-8"
        fill="none"
